...
function main() {
  ...
  generate "sf/beacon/type/v1/type.proto"
  ...
  echo "pinax-network/firehose-beacon/proto revision: `GIT_DIR=$ROOT/.git git log -n 1 --pretty=format:%h -- proto`" >> ./last_generate.txt
}
